        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentDownloadSpeed = table.Column<double>(type: "REAL", nullable: false),
                    AverageDownloadSpeed = table.Column<double>(type: "REAL", nullable: false),
                    DownloadFolder = table.Column<string>(type: "TEXT", nullable: true),
                    SpeedHistory = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileDownloadQueueItems", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    IsRegistrationEnabled = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "YoutubeDownloadQueueItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YoutubeDownloadQueueItems", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "IsRegistrationEnabled" },
