...
namespace SaveHere.Services
{
  public interface IYtdlpService
  {
    ...
    Task DownloadVideo(int itemId, string url, string? customFileName, string quality, string proxy, string? downloadFolder, string? headerOptions, CancellationToken cancellationToken);
  ...
  public class YtdlpService : IYtdlpService
  {
    ...
    public async Task DownloadVideo(int itemId, string url, string? customfilename, string quality, string proxy, string? downloadFolder, string? headerOptions, CancellationToken cancellationToken)
    {
